...
typedef enum {
    EMConnectionStateDisconnected,
    EMConnectionStatePending,
    EMConnectionStateSchemaNotFound,
    EMConnectionStateInvalidSchemaHash,
    EMConnectionStateConnected,
    EMConnectionStateDisrupted,
    EMConnectionStatePendingForDefaultSchema,
    EMConnectionStateTimeout
} EMConnectionState;
...
/**
 * A generic connection to an embedded target.
 *
