package com.commonsware.cwac.camera.components;
...
public class RotatableLayout extends FrameLayout {
    ...
    public void onAttachedToWindow() {
        ...
        if (mPrevRotation == UNKOWN_ORIENTATION) {
            mIsDefaultToPortrait = CameraUtils.isDefaultToPortrait((Activity) getContext());
    ...
    private void rotateIfNeeded() {
        ...
        int rotation = CameraUtils.getDisplayRotation((Activity) getContext());
    ...
    public void checkLayoutFlip() {
        int currentRotation = CameraUtils.getDisplayRotation((Activity) getContext());
