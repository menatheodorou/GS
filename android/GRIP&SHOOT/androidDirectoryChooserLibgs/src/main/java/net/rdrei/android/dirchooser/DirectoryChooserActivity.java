...
public class DirectoryChooserActivity extends Activity implements
    ...
    public static final String EXTRA_SELECTED_DIR_NAME = "selected_directory_name";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final String selectedDir = getIntent().getStringExtra(EXTRA_SELECTED_DIR_NAME);
        ...
        if (savedInstanceState == null) {
            ...
            final DirectoryChooserFragment fragment = DirectoryChooserFragment.newInstance(newDirName, initialDir, selectedDir);
